...
- (void)configureCell:(IFContentTableViewCell *)cell forIndexPath:(NSIndexPath *)indexPath {
    IFConfiguration *data = [self.tableData rowDataForIndexPath:indexPath];
    ...
    UIImage *image = [self.tableData loadImageWithRowData:data dataName:@"image" width:imageWidth height:imageHeight defaultImage:_rowImage];
    if (image) {
