...
#define SmokestackNamePrefix (@"smokestack")
...
- (id)init {
    ...
    if (self) {
        ...
        _commandScheduler.queueDBName = [NSString stringWithFormat:@"%@.commandqueue", SmokestackNamePrefix];
        ...
        NSString *dirName = [NSString stringWithFormat:@"%@.staging", SmokestackNamePrefix];
        _stagingPath = [cachePath stringByAppendingPathComponent:dirName];
        dirName = [NSString stringWithFormat:@"%@.app", SmokestackNamePrefix];
        ...
        dirName = [NSString stringWithFormat:@"%@.content", SmokestackNamePrefix];
