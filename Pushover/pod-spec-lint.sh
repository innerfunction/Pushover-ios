...
# CocoaPods repo.
pod spec lint Pushover.podspec --sources='ssh://git@git.innerfunction.com:22222/julian/if-podspecs.git,https://github.com/CocoaPods/Specs.git' --allow-warnings --verbose
